...
// Function to set up card flip functionality
function setupCardFlip() {
    console.log("Setting up card flip");
...
// Ensure countdown starts even if DOMContentLoaded has already fired
if (document.readyState === "complete" || document.readyState === "interactive") {
    setTimeout(function() {
        console.log("Document already loaded, starting countdown manually");
        ...
        startCountdown();
        setupCardFlip();
    }, 100); // Slightly longer delay to ensure DOM is fully processed
}

// Add a window load event as a final fallback
window.addEventListener('load', function() {
    console.log("Window fully loaded - ensuring countdown is running");
    ...
    // Always refresh card flip setup on window load
    setupCardFlip();
});
